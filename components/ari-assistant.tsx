...
const KNOWLEDGE: Record<string, string> = {
  ...
  projects:
    "Ariprakash's featured projects include WatchMan (an AI Network Traffic Analyzer), his premium Developer Portfolio, VIDEO PAKKALAMA (a YouTube clone), and a Biometric Attendance Dashboard. You can explore them in detail in the Showcase section!",
  resume:
