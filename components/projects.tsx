...
const PROJECTS: ProjectType[] = [
  ...
  },
  {
    ...
    teamSize: "1 Member",
    status: "Active",
    description: "A premium personal portfolio showcasing skills, certifications, projects, achievements, and contact information with a cinematic glassmorphic aesthetic.",
    problemStatement: "Needed a digital presence that doesn't just list skills, but proves them through exceptional UI/UX design, fluid animations, and modern web architecture.",
    solution: "Designed and developed a fully responsive Next.js portfolio leveraging Framer Motion for cinematic scrolling effects, Tailwind CSS for strict design system adherence, and glassmorphism to create a premium Silicon Valley aesthetic.",
    keyFeatures: [
      "Cinematic page transitions and scroll animations",
      "Responsive swipeable carousel and modal system",
      "Glassmorphic design language with Aurora backgrounds",
      "Integrated AI Assistant chatbot (ARI AI)",
      "Optimized performance and accessibility"
    ],
    architecture: "Built on Next.js App Router for optimal SEO and performance. Uses React state and Framer Motion for client-side interactivity, and Tailwind CSS for utility-first styling.",
    challenges: "Balancing complex Framer Motion animations with performance, ensuring smooth 60fps scrolling on mobile devices while maintaining the heavy blur and gradient effects.",
    futureEnhancements: "Add a CMS for dynamic project updates, integrate a full 3D interactive hero section using Three.js.",
  ...
  },
  {
    ...
    description: "Attendance monitoring dashboard with analytics, employee records, and reporting. Provides deep insights into workforce attendance trends.",
    problemStatement: "HR departments struggle to manually track and visualize attendance data from raw biometric hardware logs. They need an intuitive visual interface.",
    solution: "Created a comprehensive React dashboard that ingests raw attendance data and visualizes it through interactive charts, data tables, and high-level KPI cards.",
    keyFeatures: [
    ...
    architecture: "React frontend utilizing modern charting libraries (e.g. Chart.js/Recharts), connected to a robust backend API serving aggregated biometric data.",
    challenges: "Rendering complex charts and large data tables smoothly on lower-end devices without causing UI thread blocking.",
    futureEnhancements: "Add predictive analytics for employee attrition and integrate directly with payroll systems.",
    image: "/project-biometric.png",
    gallery: ["/project-biometric.png"],
    tech: ["React", "JavaScript", "CSS", "Recharts", "Node.js"],
    github: "https://github.com/",
    demo: "#",
  },
]
